...
public class MyDatabaseConnectionVertxEBProxy implements MyDatabaseConnection {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public MyDatabaseConnectionVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MyDatabaseConnectionVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  @Override
  public  void insert(JsonObject someData){
    if (closed) throw new IllegalStateException("Proxy is closed");
    JsonObject _json = new JsonObject();
    _json.put("someData", someData);
